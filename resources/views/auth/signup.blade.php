    ...
    <div class="container-fluid border">
        <div class="signup-container">
            <div class="signup-section d-flex justify-content-center">
                ...
                <div class="signup-content bg-white d-flex justify-content-center">
                                    ...
                                    <div class="form-content">
                                        ...
                                        <div class="form-element">
                                            ...
                                            <div class="input-bar d-flex">
                                                ...
                                                <span> </span>
                                                <input type="email" class="signup-form bg-white p-2"
                                        ...
                                        <div class="btn-element mt-3">
                                            ...
                                            <div class="text-center">
                                                <a href="#"><p class="h6 to-signup">Already have an account?</p></a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
